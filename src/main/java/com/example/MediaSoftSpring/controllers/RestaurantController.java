...
public class RestaurantController {
    ...
    public RestaurantResponseDTO findById(@PathVariable @Parameter(description = "Идентификатор ресторана", required = true)
    ...
    public ResponseEntity<Boolean> save(@RequestBody @Valid @Parameter(description = "DTO с данными ресторана для ввода", required = true) RestaurantRequestDTO dto){
    ...
    public ResponseEntity<Boolean> update(@PathVariable @Parameter(description = "Идентификатор ресторана", required = true)
           @Positive(message = "Id должен быть больше 0") @NotNull(message = "Id не может быть null") Long id,
    ...
    public ResponseEntity<Boolean> delete(@PathVariable @Parameter(description = "Идентификатор ресторана", required = true)
           @Positive(message = "Id должен быть больше 0") @NotNull(message = "Id не может быть null") Long id){
